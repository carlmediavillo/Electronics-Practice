...
void loop() {
          ...
          switch(clkMode) {
            ...
            case 4:
              switch(clkState) {
                case 1:
                  clkState = 2;
                  //Go to State for setting stepper direction
                  Serial.println(clkState);
                break;
              }
            break;
          ...
          switch(clkMode) {
            ...
            case 4:
              switch(clkState) {
                case 2:
                  clkState = 3;
                  //go to state for rotating the stepper
                  Serial.println(clkState);
                break;
  ...
  if (clkMode == 4) {
    switch(clkState) {
      ...
      case 3:
        lcd.setCursor(0, 0);
        lcd.print("Rotation Mode   ");

        lcd.setCursor(0, 1);
        lcd.print("Push 1 to rotate");
      break;
    }
  }
}
